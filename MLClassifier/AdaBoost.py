...
byes_clf=AdaBoostClassifier(DecisionTreeClassifier(max_depth=2),n_estimators=100,learning_rate=1.0)
byes_clf.fit(train_x,train_y)
predict=byes_clf.predict(test_x)


#交叉验证
from sklearn.model_selection import cross_val_score
print('交叉验证结果:')
print(cross_val_score(byes_clf,test_x,test_y,cv=3))
